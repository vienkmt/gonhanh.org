...
- Nguyễn Đình Hoà (1997). *Vietnamese: Tiếng Việt không son phấn*. John Benjamins Publishing.
- Thompson, Laurence C. (1965). *A Vietnamese Grammar*. University of Washington Press.
- Đoàn Thiện Thuật (1977). *Ngữ âm tiếng Việt*. NXB Đại học và Trung học chuyên nghiệp.

---

## Changelog

- **2024-12-07**: Tạo tài liệu toàn diện
